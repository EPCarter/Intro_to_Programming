...
Author: Erik Carter Email: Carter.Eri7200 stu.stech.edu Course: CSCI 1105 - Introduction to Programming Assignment: 3-23 //? Can Date: Sept. 12, 2018

Summary: (Geometry: point in a rectangle?) Write a program that prompts the user to enter a point (x, y) and checks whether the point is within the rectangle centered at (0, 0) with width 10 and height 5. For example, (2, 2) is inside the rectangle and (6, 4) is outside the rectangle, as shown in Figure 3.7b.
...
public class Main { //? What are the principles in correct naming of classes?  public static void main(String[] args){ //? What about here?  Scanner reader = new Scanner(System.in);
...
/*
TODO Remove blank decimals (eg. 2.0 >> 2) if(x % 1 <= 0){ x = x;
}
